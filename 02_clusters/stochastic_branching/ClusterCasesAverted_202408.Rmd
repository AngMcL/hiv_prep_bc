...
# C. L. Althaus, Ebola superspreading. Lancet Infect. Dis. 15, 507–508 (2015).
...
initialrun<-FALSE #initial run TRUE if calculating seed adjust - shouldn't have to if have already run see seedadjust below
